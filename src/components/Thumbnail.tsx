...
const Thumbnail = () => {
  ...
  return (
    <div className="px-4">
      ...
      {selectedImage && (
        <div
          className="fixed inset-0 bg-transparent bg-opacity-70 backdrop-blur-sm flex items-center justify-center z-50 p-4"
          onClick={closeModal}
        >
          <div className="relative">
            <button
              onClick={closeModal}
              className="absolute -top-12 right-0 cursor-pointer bg-gray-800 text-white text-xl hover:bg-gray-600 transition-colors rounded-full w-10 h-10 flex items-center justify-center shadow-lg z-10"
            >
              ✕
            </button>
            <Image
